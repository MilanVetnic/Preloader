(function(i) {
            ...
            for (var t = e.childNodes, i = 0; i < t.length; i++)
                if (t[i].nodeType === window.Node.TEXT_NODE) {
                    ...
                    for (var r = n.split(" "), s = 0; s < r.length; s++) {
                        ...
                        a.classList.add("js-textContainer__word"), a.classList.add("textContainer__word");
    ...
    function(module, _exports) {
        module.exports = function(obj) {
            ...
            with(obj)
            __p +=
                '<div class="mainLoader">\n  <div class="js-mainLoader__loading mainLoader__loading">LOADING</div>\n  <div class="js-mainLoader__container mainLoader__container">\n    <div class="js-mainLoader__title mainLoader__title font-title">Milina</div>\n    <div class="js-mainLoader__subtitle mainLoader__subtitle font-shell">Svilenkasti Aksesoari & Pure Material</div>\n  </div>\n\n  <div class="js-mainLoader__text mainLoader__text font-light"></div>\n  <div class="js-mainLoader__line mainLoader__line"></div>\n</div>';
            return __p;
        };
    },
    function(_e, _t) {},
    ...
    function(_e, t, i) {
                        ...
                        A()(e, [{
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    1600 < e && (t = 62.5 + 0.045 * (e - 1600)), (document.documentElement.style.fontSize = "".concat(t, "%"));
                                },
                            },
                            {
                                key: "onAssetsLoaded",
        ...
        j()(function() {
            ...
            (i.onload = function() {
                console.log(1), (t = t || new ke());
            }),
            i.addEventListener &&
                i.addEventListener(
                    "load",
                    function() {
                        console.log(2), (t = t || new ke());
                    }, !1
                ),
                (i.onreadystatechange = function() {
                    var e = i.readyState;
                    ("loaded" !== e && "complete" !== e) || (console.log(3), (i.onreadystatechange = null), (t = t || new ke()));
                });
            var n = document.styleSheets.length,
                o = setInterval(function() {
                    document.styleSheets.length > n && (console.log(4), (t = t || new ke()), clearInterval(o));
                }, 10);
            e.appendChild(i);
        });
    },
